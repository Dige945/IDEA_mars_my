...
_C.MODEL.DEVICE_ID = '3'  # GPU ID to use
_C.MODEL.NAME = 'IDEA'  # Name of the model
_C.MODEL.PRETRAIN_PATH_T = '/data2/xieyudi/IDEA/PTH/ViT-B-16.pt'  # Path to the pretrained ViT backbone
...
_C.MODEL.ID_LOSS_WEIGHT = 1.0  # Weight for ID loss，0.25 for CLIP, 1.0 for ViT
...
_C.MODEL.SDM_LOSS_WEIGHT = 0.5 #SDM loss weight
_C.MODEL.CMPC_LOSS_WEIGHT = 0 #cmpc loss weight
_C.MODEL.ITC_LOSS_WEIGHT = 0.5 #ITC loss
